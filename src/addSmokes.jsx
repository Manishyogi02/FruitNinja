...
const addSmokes = (app, train) => {
    const groupCount = 5
    const particleCount = 7

    //create array to hold all the smokes
    const groups = []
    ...
    for (let index = 0; index < groupCount; index++) {
        ...
        //Add the tick custom property to the smoke group for storing the animation progress ratio
        smokeGroup.tick = index * (1 / groupCount)

        //add the smoke group to the stage and reference array
        ...
        app.ticker.add((time) => {
            ...
            const dt = time.deltaTime * 0.001
            groups.forEach((group) => {
                //animate the progress ratio
